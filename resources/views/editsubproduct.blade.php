                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="space-y-2">
                                ...
                                <input type="text"
                                    ...
                                    id="subproduct" name="subproduct" value="{{ $subproduct->subproduct }}" required>
                            </div>
                            <div class="space-y-2">
                                <label class="font-semibold text-black">Price:</label>
                                <input type="number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-lg w-full"
                                    id="price" name="price" value="{{ $subproduct->price }}" required>
                            </div>
                            <div class="space-y-2">
                                <label class="font-semibold text-black">Min:</label>
                                <input type="number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 p-2 rounded-lg w-full"
                                    id="min" name="min" value="{{ $subproduct->min }}" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="space-y-2">
