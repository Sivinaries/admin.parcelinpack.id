...
<body>
    ...
    <div class="h-screen w-full mx-auto bg-gradient-to-b from-orange-500 to-orange-100 flex items-center p-4 xl:p-0 2xl:p-0">
        <div class="mx-auto sm:max-w-sm w-full space-y-3 p-8 bg-white rounded-3xl">
            <div class="space-y-3">
                <a href="">
                    <div class="my-auto">
                        <img class="w-24 h-24" src="{{ asset('assets/img/logo.png') }}" alt="">
                    </div>
                </a>
                <div>
            ...
            <form method="post" action="{{ route('masuk') }}" class="space-y-6">
                ...
                <div
                    class='border-4 border-orange-500 p-2 rounded-3xl w-3/5 mx-auto hover:scale-110 duration-200 transition-all'>
